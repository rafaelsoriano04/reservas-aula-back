...
const LabReservations = () => {
  ...
  const updateWeekRange = () => {
    ...
    setWeekDates(dates);
    setMonday(monday);
    setWeekRange(`Semana del: ${formatDisplayDate(monday)} - ${formatDisplayDate(dates[5])}`); // Use formatDisplayDate for UI
  };
  ...
  return (
    <div className="container mt-3">
      ...
      <div className="row">
        ...
        <div className="col-md-12 d-flex justify-content-center align-items-center nav-buttons">
